...
approach_position = [xpos, ypos,  0.15]  # 10cm above the object
...
retract_position = [0.85, -0.05, 0.15]
palmP(retract_position, initial_orientation)
for _ in range(700):  # Increase the number of steps
    p.stepSimulation()
    time.sleep(0.01)  # Slow down the simulation
...
move_to_tray_position = [tray_x, tray_y+ 0.2, -0.03 + 0.1]  # Directly over the tray but 10cm above
